...
const featuredRecipes = [
  ...
  // Dinner Recipes
  {
    ...
    "instructions": [
      "Heat oil or ghee in a heavy-bottomed pan. Add whole spices (cloves, cardamom, cinnamon) and sauté for a minute.",
      "Add chopped onions and fry until golden brown.",
      "Add ginger-garlic paste and sauté for another minute.",
      "Add the lamb pieces and brown them on all sides.",
      "In a bowl, whisk the yogurt and mix in Kashmiri red chili powder, fennel powder, and dry ginger powder. Pour this mixture over the lamb.",
      "Stir continuously on low heat to prevent the yogurt from curdling.",
      "Add tomato puree and salt. Cover and cook on low heat until the lamb is tender and the oil separates from the masala (about 45-50 mins)."
    ]
  },
  {
    "id": 8,
    ...
    "instructions": [
      "Blanch the spinach in boiling water for 2-3 minutes. Immediately transfer to a bowl of ice water to retain its color. Drain and blend into a smooth puree.",
      "Heat oil or ghee in a pan. Add cumin seeds and let them splutter.",
      "Add chopped onion and sauté until translucent. Add ginger-garlic paste and cook for another minute.",
      "Stir in the tomato puree, turmeric powder, and salt. Cook until the oil separates.",
      "Pour the spinach puree into the pan and mix well. Simmer for 5-7 minutes.",
      "Add the paneer cubes and garam masala. Gently stir and cook for 2-3 minutes.",
      "Stir in fresh cream (if using) and serve hot with roti or rice."
    ]
  },
  {
    "id": 9,
